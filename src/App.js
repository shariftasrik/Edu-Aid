...
import Cart from './Pages/Cart'; // Uncomment and adjust path if needed
import { CartContextProvider } from './CartContext'; // Uncomment to wrap the app with CartContext
...
function App() {
  ...
  return (
    <Router>
      <CartContextProvider> {/* Wrap the app with CartProvider */}
        ...
        <div className="App">
          ...
          <div className="content">
            <Routes>
              ...
              {/* Route to Cart Page */}
              <Route path="/cart" element={<Cart />} /> {/* Uncomment if Cart is used */}
            </Routes>
          </div>
